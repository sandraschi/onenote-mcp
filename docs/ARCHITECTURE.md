...
| Webapp | `web_sota/src` (React, Zustand `store/llm.ts`, TanStack Query) | Dashboard, Notebooks, Tools, Status, Apps, Skills, Chat (backend LLM proxy), Logging, Help, Settings |

...
export function Apps() {
    const apps = [
        ...
        { name: "Reversing MCP", port: 10888, description: "Binary instrumentation hub" },
        { name: "Ring MCP", port: 10890, description: "Doorbell & security monitoring" },
        { name: "Obsidian MCP", port: 10892, description: "Knowledge base bridge" },
        { name: "OneNote MCP", port: 10894, description: "MS OneNote integration" },
        { name: "qBittorrent MCP", port: 10896, description: "Torrent automation" },
    ];
